...
# Aya custom: am_payloads.xml is an optional extended WAF-bypass set enabled via --AM
PAYLOAD_XML_FILES = ("boolean_blind.xml", "error_based.xml", "inline_query.xml", "stacked_queries.xml", "time_blind.xml", "union_query.xml", "am_payloads.xml")
