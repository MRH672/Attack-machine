...
def cmdLineParser(argv=None):
    ...
    try:
        ...
        # Aya custom: use extended User-Agent list from data/txt/custom-agents.txt
        request.add_argument("--Aegnt", dest="aegnt", action="store_true",
            help="Use extended custom HTTP User-Agent list for WAF bypass")
        ...
        # Aya custom WAF/Bypass options
        waf = parser.add_argument_group("WAF/Bypass", "Custom WAF/WAF-bypass options (Aya extensions)")

        waf.add_argument("--AM", dest="amPayloads", action="store_true",
            help="Use extended WAF-bypass payload set (am_payloads.xml & payloads.txt)")
